...
const DocsHeading = (props) => (
  <HStack
    pl={props.as === 'h2' && 4}
    borderLeft={props.as === 'h2' && '4px solid #63b3ed'}
  >
    <Link
      color="displayColor"
      _hover={{
...
const MDXComponents = {
  ...
  img: (props) => <Image width={1366} height={768} alt={props.alt || 'Image'} {...props} />,
  inlineCode: (props) => (
  ...
  VideoPlayer: (props) => <VideoPlayer {...props} />,  // Add VideoPlayer component
  ImageCarousel: (props) => <ImageCarousel {...props} />,
